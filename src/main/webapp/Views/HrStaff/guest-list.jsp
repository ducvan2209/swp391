...
<head>
    ...
    <title>Candidate List – HR Management</title>
...
<div class="topbar d-flex align-items-center gap-3">
    ...
    <div>
        ...
        <p>Human Resources &rsaquo; Recruitment &rsaquo; Candidates</p>
    </div>
</div>
    ...
    <div class="card card-custom">
        ...
        <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div class="d-flex align-items-center gap-2">
                <span class="fw-semibold text-dark">All Candidates</span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-semibold text-primary">
                                                #<c:out value="${guest.guestId}" />
                                            </span>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar">
                                                    <c:out value="${fn:toUpperCase(fn:substring(guest.fullName, 0, 1))}" default="?" />
                                                </div>
                                        ...
                                        <td>
                                            <a href="mailto:<c:out value='${guest.email}'/>"
                                               class="text-decoration-none text-dark">
                                                <c:out value="${guest.email}" default="—" />
                                            </a>
                                        </td>
                                        <td><c:out value="${guest.phone}" default="—" /></td>
                                        <td>
                                            <c:choose>
                                            ...
                                            <c:choose>
                                                <c:when test="${guest.status == 'Processing'}">
                                                    <span class="badge badge-processing rounded-pill px-3 py-1">
                                                        <i class="bi bi-circle-fill me-1" style="font-size:.5rem;"></i>Processing
                                                    </span>
                                                </c:when>
                                                <c:when test="${guest.status == 'Hired'}">
                                                    <span class="badge badge-hired rounded-pill px-3 py-1">
                                                        <i class="bi bi-circle-fill me-1" style="font-size:.5rem;"></i>Hired
                                                    </span>
                                                </c:when>
                                                <c:when test="${guest.status == 'Rejected'}">
                                                    <span class="badge badge-rejected rounded-pill px-3 py-1">
                                                        <i class="bi bi-circle-fill me-1" style="font-size:.5rem;"></i>Rejected
                                                    </span>
                                                </c:when>
                                                <c:otherwise>
                                        ...
                                        <td class="text-center">
                                            <a href="${pageContext.request.contextPath}/guest/detail?id=${guest.guestId}"
        ...
        <div class="card-footer bg-white border-top border-light text-muted"
            ...
            Showing <span id="visibleCount"></span> of ${guests.size()} candidates
        </div>
